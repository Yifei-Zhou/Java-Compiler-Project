...
if __name__ == "__main__":
    st = SymbolTable()
    st.addVariable(Scope.Type(Scope.InnerType.INT), "x")
    st.addVariable(Scope.Type(Scope.InnerType.INT), "y")
    st.addVariable(Scope.Type(Scope.InnerType.STRING), "z", "Hello")
    st.addVariable(Scope.Type(Scope.InnerType.STRING), "w", "World")
