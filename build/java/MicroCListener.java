...
public interface MicroCListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MicroCParser#negop}.
	 * @param ctx the parse tree
	 */
	void enterNegop(MicroCParser.NegopContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroCParser#negop}.
	 * @param ctx the parse tree
	 */
	void exitNegop(MicroCParser.NegopContext ctx);
	/**
